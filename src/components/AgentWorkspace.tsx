...
import type { CodexAppServerEvent, CodexAppServerSession, CodexTurnSummary } from "../database";
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "welcome",
      role: "assistant",
      text: "Describe the Method you want to design. I can help shape the workflow; draft tools and graph state appear in the next slice.",
      status: "completed",
    },
  ]);
      ...
      <main className="agent-chat-main">
        ...
        <aside className="agent-visual-panel">
          <div className="agent-visual-header">
            <div>
              <h2>Methods</h2>
              <p>Drafting tools coming next</p>
            </div>
          </div>

          <div className="agent-empty-visual">
            The Method graph will appear here once draft creation is wired in. For now, use chat to explore the
            benchmark shape and required resources.
          </div>
        </aside>
      </main>
    </div>
